            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <a href="admin/pickup_location/add" class="btn btn-outline-primary">Add a new location</a>
                        <br>
                        <br>
                        @if(session('alert'))
                            ...
                            <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                ...
                                @foreach($PickupLocation as $item)
                                    <tr>
                                        ...
                                        <td>{{$item -> phone}}</td>
                                        <td>
                                            <a href="admin/pickup_location/edit/{{$item -> id}}" class="btn btn-sm btn-outline-primary">Edit</a>
                                            <a href="admin/pickup_location/delete/{{$item -> id}}" class="btn btn-sm btn-outline-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
