            ...
            <div class="col-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="mt-4" action="admin/pickup_location/edit/{{$PickupLocation->id}}" method="POST">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <div class="form-group">
                                <input type="text"
                                       class="form-control col-md-12 {{ $errors->has('name') ? 'is-invalid' : ''}}"
                                       placeholder="Branch Name" name="name" value="{{$PickupLocation -> name}}">
                            ...
                            <div class="form-group">
                                <input type="text"
                                       ...
                                       placeholder="Address" name="address" value="{{$PickupLocation -> address}}">
                            ...
                            <div class="form-group">
                                <input type="number"
                                       ...
                                       placeholder="Phone Number" name="phone" value="{{$PickupLocation -> phone}}">
                                {!! $errors->first('phone', '<div class="invalid-feedback">:message</div>') !!}
                            </div>

                            <button type="submit" class="btn btn-info">Submit</button>
                            <a href="admin/pickup_location/view" class="btn btn-dark">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
