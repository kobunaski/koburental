    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Vehicle information</h4>
                        ...
                        @endif
                        <form class="mt-4" action="admin/vehicle/edit/{{$Vehicle -> id}}" method="POST"  enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <div class="form-group">
                                <input type="text"
                                       class="form-control col-md-12 {{ $errors->has('name') ? 'is-invalid' : ''}}"
                                       placeholder="Full Name" name="name" value="{{$Vehicle -> name}}">
                            ...
                            <div class="form-group">
                                <input type="text"
                                       ...
                                       placeholder="Daily Price" name="daily_price" value="{{$Vehicle -> daily_price}}">
                                {!! $errors->first('daily_price', '<div class="invalid-feedback">:message</div>') !!}
                            </div>

                            <img src="upload/image/vehicle_image/{{$Vehicle -> image}}" id="preview_img"  alt="" style="width: 200px;height: auto">
