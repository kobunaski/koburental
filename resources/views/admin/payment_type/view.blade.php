                            ...
                            <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                ...
                                @foreach($PaymentType as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="admin/payment_type/edit/{{$item -> id}}" class="btn btn-sm btn-outline-primary">Edit</a>
                                            <a href="admin/payment_type/delete/{{$item -> id}}" class="btn btn-sm btn-outline-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
