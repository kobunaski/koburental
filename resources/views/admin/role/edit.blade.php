            ...
            <div class="col-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="mt-4" action="admin/role/edit/{{$Role -> id}}" method="POST">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <div class="form-group">
                                <input type="text" class="form-control col-md-12 text-lowercase {{ $errors->has('name') ? 'is-invalid' : ''}}" placeholder="Role Name" name="name" value="{{$Role -> name}}">
