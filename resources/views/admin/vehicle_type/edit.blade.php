    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Model Type</h4>
                        ...
                        @endif
                        <form class="mt-4" action="admin/vehicle_type/edit/{{$VehicleType -> id}}" method="POST">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <div class="form-group">
                                <input type="text"
                                       class="form-control col-md-12 {{ $errors->has('name') ? 'is-invalid' : ''}}"
                                       placeholder="Full Name" name="name" value="{{$VehicleType -> name}}">
                            ...
                            <div class="form-group">
                                <select name="id_manufacture" class="form-control {{ $errors->has('id_manufacture') ? 'is-invalid' : ''}}">
                                    ...
                                    @foreach($Manufacture as $item)
                                        @if($item -> id == $VehicleType -> id_manufacture)
