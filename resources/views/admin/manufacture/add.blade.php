    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add new manufacture</h4>
                        ...
                        @endif
                        <form class="mt-4" action="admin/manufacture/add" method="POST">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <div class="form-group">
                                <input type="text" class="form-control col-md-12 {{ $errors->has('name') ? 'is-invalid' : ''}}" placeholder="Manufacture Name" name="name">
                                {!! $errors->first('name', '<div class="invalid-feedback">:message</div>') !!}
                            </div>
                            <button type="submit" class="btn btn-info">Submit</button>
                            <a href="admin/role/view" class="btn btn-dark">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
