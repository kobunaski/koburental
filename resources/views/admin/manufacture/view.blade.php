            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <a href="admin/manufacture/add" class="btn btn-outline-primary">Add a new manufacture</a>
                        <br>
                        <br>
                        @if(session('alert'))
                            ...
                            <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                ...
                                @foreach($Manufacture as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="admin/manufacture/edit/{{$item -> id}}" class="btn btn-sm btn-outline-primary">Edit</a>
                                            <a href="admin/manufacture/delete/{{$item -> id}}" class="btn btn-sm btn-outline-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
