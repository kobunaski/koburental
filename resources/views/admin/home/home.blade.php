    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                @if(isset($user_login))
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Good Morning {{$user_login -> name}}!</h3>
                @endif
                    ...
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        ...
                        <span class="opacity-7 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    ...
                                    d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7"
                                                                                                 r="4"></circle><line
                                    x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        ...
                        <span class="opacity-7 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                ...
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="feather feather-dollar-sign"><line x1="12" y1="1"
                                                                                                          x2="12"
                                                                                                          y2="23"></line><path
                ...
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        ...
                        <span class="opacity-7 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                ...
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="feather feather-file-plus"><path
                                    d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline
                                    points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line
                                    x1="9" y1="15" x2="15" y2="15"></line></svg></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        ...
                        <span class="opacity-7 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                ...
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="feather feather-globe"><circle cx="12" cy="12"
                                                                                                      r="10"></circle><line
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="campaign-v2" class="mt-2 c3"
                             style="height: 283px; width: 100%; max-height: 283px; position: relative;">
                            <svg width="223.25" height="283" style="overflow: hidden;">
                                <defs>
                                    <clipPath id="c3-1587526713352-clip">
                                        <rect width="223.25" height="259"></rect>
                                    </clipPath>
                                    <clipPath id="c3-1587526713352-clip-xaxis">
                                        <rect x="-31" y="-20" width="285.25" height="40"></rect>
                                    </clipPath>
                                    <clipPath id="c3-1587526713352-clip-yaxis">
                                        <rect x="-29" y="-4" width="20" height="283"></rect>
                                    </clipPath>
                                    <clipPath id="c3-1587526713352-clip-grid">
                                        <rect width="223.25" height="259"></rect>
                                    </clipPath>
                                    <clipPath id="c3-1587526713352-clip-subchart">
                                        <rect width="223.25"></rect>
                                    </clipPath>
                                </defs>
                                <g transform="translate(0.5,4.5)">
                                    <text class="c3-text c3-empty" text-anchor="middle" dominant-baseline="middle"
                                          x="111.625" y="129.5" style="opacity: 0;"></text>
                                    <rect class="c3-zoom-rect" width="223.25" height="259" style="opacity: 0;"></rect>
                                    <g clip-path="url(file:///Users/giangvu/Documents/FinalProject/Templates/AdminTemplate/package/src/html/index.html#c3-1587526713352-clip)"
                                       class="c3-regions" style="visibility: hidden;"></g>
                                    <g clip-path="url(file:///Users/giangvu/Documents/FinalProject/Templates/AdminTemplate/package/src/html/index.html#c3-1587526713352-clip-grid)"
                                       class="c3-grid" style="visibility: hidden;">
                                        <g class="c3-xgrid-focus">
                                            <line class="c3-xgrid-focus" x1="-10" x2="-10" y1="0" y2="259"
                                    ...
                                    <g clip-path="url(file:///Users/giangvu/Documents/FinalProject/Templates/AdminTemplate/package/src/html/index.html#c3-1587526713352-clip)"
                                       class="c3-chart">
                                        <g class="c3-event-rects c3-event-rects-single" style="fill-opacity: 0;">
                                            <rect class=" c3-event-rect c3-event-rect-0" x="0.375" y="0" width="223.25"
                                                  height="259"></rect>
                                        </g>
                                        <g class="c3-chart-bars">
                                            <g class="c3-chart-bar c3-target c3-target-Direct-Sales"
                                               style="pointer-events: none;">
                                                <g class=" c3-shapes c3-shapes-Direct-Sales c3-bars c3-bars-Direct-Sales"
                                                   style="cursor: pointer;"></g>
                                            </g>
                                            <g class="c3-chart-bar c3-target c3-target-Referral-Sales"
                                               style="pointer-events: none;">
                                                <g class=" c3-shapes c3-shapes-Referral-Sales c3-bars c3-bars-Referral-Sales"
                                                   style="cursor: pointer;"></g>
                                            </g>
                                            <g class="c3-chart-bar c3-target c3-target-Afilliate-Sales"
                                               style="pointer-events: none;">
                                                <g class=" c3-shapes c3-shapes-Afilliate-Sales c3-bars c3-bars-Afilliate-Sales"
                                                   style="cursor: pointer;"></g>
                                            </g>
                                            <g class="c3-chart-bar c3-target c3-target-Indirect-Sales"
                                               style="pointer-events: none;">
                                                <g class=" c3-shapes c3-shapes-Indirect-Sales c3-bars c3-bars-Indirect-Sales"
                                                   style="cursor: pointer;"></g>
                                            </g>
                                        </g>
                                        <g class="c3-chart-lines">
                                            <g class="c3-chart-line c3-target c3-target-Direct-Sales"
                                               style="opacity: 1; pointer-events: none;">
                                                <g class=" c3-shapes c3-shapes-Direct-Sales c3-lines c3-lines-Direct-Sales"></g>
                                                <g class=" c3-shapes c3-shapes-Direct-Sales c3-areas c3-areas-Direct-Sales"></g>
                                                <g class=" c3-selected-circles c3-selected-circles-Direct-Sales"></g>
                                                <g class=" c3-shapes c3-shapes-Direct-Sales c3-circles c3-circles-Direct-Sales"
                                                   style="cursor: pointer;"></g>
                                            </g>
                                            <g class="c3-chart-line c3-target c3-target-Referral-Sales"
                                               style="opacity: 1; pointer-events: none;">
                                                <g class=" c3-shapes c3-shapes-Referral-Sales c3-lines c3-lines-Referral-Sales"></g>
                                                <g class=" c3-shapes c3-shapes-Referral-Sales c3-areas c3-areas-Referral-Sales"></g>
                                                <g class=" c3-selected-circles c3-selected-circles-Referral-Sales"></g>
                                                <g class=" c3-shapes c3-shapes-Referral-Sales c3-circles c3-circles-Referral-Sales"
                                                   style="cursor: pointer;"></g>
                                            </g>
                                            <g class="c3-chart-line c3-target c3-target-Afilliate-Sales"
                                               style="opacity: 1; pointer-events: none;">
                                                <g class=" c3-shapes c3-shapes-Afilliate-Sales c3-lines c3-lines-Afilliate-Sales"></g>
                                                <g class=" c3-shapes c3-shapes-Afilliate-Sales c3-areas c3-areas-Afilliate-Sales"></g>
                                                <g class=" c3-selected-circles c3-selected-circles-Afilliate-Sales"></g>
                                                <g class=" c3-shapes c3-shapes-Afilliate-Sales c3-circles c3-circles-Afilliate-Sales"
                                                   style="cursor: pointer;"></g>
                                            </g>
                                            <g class="c3-chart-line c3-target c3-target-Indirect-Sales"
                                               style="opacity: 1; pointer-events: none;">
                                                <g class=" c3-shapes c3-shapes-Indirect-Sales c3-lines c3-lines-Indirect-Sales"></g>
                                                <g class=" c3-shapes c3-shapes-Indirect-Sales c3-areas c3-areas-Indirect-Sales"></g>
                                                <g class=" c3-selected-circles c3-selected-circles-Indirect-Sales"></g>
                                                <g class=" c3-shapes c3-shapes-Indirect-Sales c3-circles c3-circles-Indirect-Sales"
                                                   style="cursor: pointer;"></g>
                                            </g>
                                        </g>
                                        <g class="c3-chart-arcs" transform="translate(111.625,124.5)">
                                            <text class="c3-chart-arcs-title"
                                                  style="text-anchor: middle; opacity: 1; font-family: Rubik;">Sales
                                            </text>
                                            <g class="c3-chart-arc c3-target c3-target-Direct-Sales">
                                                <g class=" c3-shapes c3-shapes-Direct-Sales c3-arcs c3-arcs-Direct-Sales">
                                                    <path class=" c3-shape c3-shape c3-arc c3-arc-Direct-Sales"
                                                          transform=""
                                                          style="fill: rgb(237, 242, 246); cursor: pointer;"
                                                          d="M6.493306950354106e-15,-106.04374999999999A106.04374999999999,106.04374999999999 0 0,1 70.32001338982234,79.37488665136917L58.38380554148802,65.90169318428936A88.04374999999999,88.04374999999999 0 0,0 5.391124831121488e-15,-88.04374999999999Z"></path>
                                                </g>
                                                <text dy=".35em" class=""
                                                      transform="translate(79.32210294821715,-30.08290559225351)"
                                                      style="opacity: 1; text-anchor: middle; pointer-events: none;"></text>
                                            </g>
                                            <g class="c3-chart-arc c3-target c3-target-Referral-Sales">
                                                <g class=" c3-shapes c3-shapes-Referral-Sales c3-arcs c3-arcs-Referral-Sales">
                                                    <path class=" c3-shape c3-shape c3-arc c3-arc-Referral-Sales"
                                                          transform="" style="fill: rgb(95, 118, 232); cursor: pointer;"
                                                          d="M70.32001338982234,79.37488665136917A106.04374999999999,106.04374999999999 0 0,1 -70.32001338982226,79.37488665136924L-58.38380554148795,65.90169318428941A88.04374999999999,88.04374999999999 0 0,0 58.38380554148802,65.90169318428936Z"></path>
                                                </g>
                                                <text dy=".35em" class=""
                                                      transform="translate(4.2868953677913346e-14,84.835)"
                                                      style="opacity: 1; text-anchor: middle; pointer-events: none;"></text>
                                            </g>
                                            <g class="c3-chart-arc c3-target c3-target-Afilliate-Sales">
                                                <g class=" c3-shapes c3-shapes-Afilliate-Sales c3-arcs c3-arcs-Afilliate-Sales">
                                                    <path class=" c3-shape c3-shape c3-arc c3-arc-Afilliate-Sales"
                                                          transform="" style="fill: rgb(255, 79, 112); cursor: pointer;"
                                                          d="M-87.27229532886048,-60.2397159861719A106.04374999999999,106.04374999999999 0 0,1 -1.1366569114513745e-13,-106.04374999999999L-9.437193323283735e-14,-88.04374999999999A88.04374999999999,88.04374999999999 0 0,0 -72.45858574277466,-50.01455054501111Z"></path>
                                                </g>
                                                <text dy=".35em" class=""
                                                      transform="translate(-39.424790300333214,-75.11766193628999)"
                                                      style="opacity: 1; text-anchor: middle; pointer-events: none;"></text>
                                            </g>
                                            <g class="c3-chart-arc c3-target c3-target-Indirect-Sales">
                                                <g class=" c3-shapes c3-shapes-Indirect-Sales c3-arcs c3-arcs-Indirect-Sales">
                                                    <path class=" c3-shape c3-shape c3-arc c3-arc-Indirect-Sales"
                                                          transform="" style="fill: rgb(1, 202, 241); cursor: pointer;"
                                                          d="M-70.32001338982226,79.37488665136924A106.04374999999999,106.04374999999999 0 0,1 -87.27229532886048,-60.2397159861719L-72.45858574277466,-50.01455054501111A88.04374999999999,88.04374999999999 0 0,0 -58.38380554148795,65.90169318428941Z"></path>
                                                </g>
                                                <text dy=".35em" class=""
                                                      transform="translate(-84.21645733410838,10.225729269460444)"
                                                      style="opacity: 1; text-anchor: middle; pointer-events: none;"></text>
                                            </g>
                                        </g>
                                        <g class="c3-chart-texts">
                                            <g class="c3-chart-text c3-target c3-target-Direct-Sales"
                                               style="opacity: 1; pointer-events: none;">
                                                <g class=" c3-texts c3-texts-Direct-Sales"></g>
                                            </g>
                                            <g class="c3-chart-text c3-target c3-target-Referral-Sales"
                                               style="opacity: 1; pointer-events: none;">
                                                <g class=" c3-texts c3-texts-Referral-Sales"></g>
                                            </g>
                                            <g class="c3-chart-text c3-target c3-target-Afilliate-Sales"
                                               style="opacity: 1; pointer-events: none;">
                                                <g class=" c3-texts c3-texts-Afilliate-Sales"></g>
                                            </g>
                                            <g class="c3-chart-text c3-target c3-target-Indirect-Sales"
                                               style="opacity: 1; pointer-events: none;">
                                                <g class=" c3-texts c3-texts-Indirect-Sales"></g>
                                            </g>
                                        </g>
                                    </g>
                                    <g clip-path="url(file:///Users/giangvu/Documents/FinalProject/Templates/AdminTemplate/package/src/html/index.html#c3-1587526713352-clip-grid)"
                                    ...
                                    <g class="c3-axis c3-axis-x"
                                       clip-path="url(file:///Users/giangvu/Documents/FinalProject/Templates/AdminTemplate/package/src/html/index.html#c3-1587526713352-clip-xaxis)"
                                       transform="translate(0,259)" style="visibility: visible; opacity: 0;">
                                        <text class="c3-axis-x-label" transform="" style="text-anchor: end;" x="223.25"
                                              dx="-0.5em" dy="-0.5em"></text>
                                        <g class="tick" transform="translate(112, 0)" style="opacity: 1;">
                                            <line x1="0" x2="0" y2="6"></line>
                                            <text x="0" y="9" transform="" style="text-anchor: middle; display: block;">
                                                <tspan x="0" dy=".71em" dx="0">0</tspan>
                                            </text>
                                        </g>
                                        <path class="domain" d="M0,6V0H223.25V6"></path>
                                    </g>
                                    <g class="c3-axis c3-axis-y"
                                       clip-path="url(file:///Users/giangvu/Documents/FinalProject/Templates/AdminTemplate/package/src/html/index.html#c3-1587526713352-clip-yaxis)"
                                       transform="translate(0,0)" style="visibility: visible; opacity: 0;">
                                        ...
                                        <g class="tick" transform="translate(0,238)" style="opacity: 1;">
                                            <line x2="-6"></line>
                                            <text x="-9" y="0" style="text-anchor: end;">
                                                <tspan x="-9" dy="3">10</tspan>
                                            </text>
                                        </g>
                                        <g class="tick" transform="translate(0,209)" style="opacity: 1;">
                                            <line x2="-6"></line>
                                            <text x="-9" y="0" style="text-anchor: end;">
                                        ...
                                        <g class="tick" transform="translate(0,152)" style="opacity: 1;">
                                            <line x2="-6"></line>
                                            <text x="-9" y="0" style="text-anchor: end;">
                                                <tspan x="-9" dy="3">16</tspan>
                                            </text>
                                        </g>
                                        <g class="tick" transform="translate(0,123)" style="opacity: 1;">
                                            <line x2="-6"></line>
                                            <text x="-9" y="0" style="text-anchor: end;">
                                        ...
                                        <path class="domain" d="M-6,1H0V259H-6"></path>
                                    </g>
                                    <g class="c3-axis c3-axis-y2" transform="translate(223.25,0)"
                                       style="visibility: hidden; opacity: 0;">
                                        <text class="c3-axis-y2-label" transform="rotate(-90)" style="text-anchor: end;"
                                              x="0" dx="-0.5em" dy="-0.5em"></text>
                                        <g class="tick" transform="translate(0,259)" style="opacity: 1;">
                                            <line x2="6" y2="0"></line>
                                            <text x="9" y="0" style="text-anchor: start;">
                                                <tspan x="9" dy="3">0</tspan>
                                            </text>
                                        </g>
                                        <g class="tick" transform="translate(0,234)" style="opacity: 1;">
                                            <line x2="6" y2="0"></line>
                                            <text x="9" y="0" style="text-anchor: start;">
                                        ...
                                        <g class="tick" transform="translate(0,182)" style="opacity: 1;">
                                            <line x2="6" y2="0"></line>
                                            <text x="9" y="0" style="text-anchor: start;">
                                                <tspan x="9" dy="3">0.3</tspan>
                                            </text>
                                        </g>
                                        <g class="tick" transform="translate(0,156)" style="opacity: 1;">
                                            <line x2="6" y2="0"></line>
                                            <text x="9" y="0" style="text-anchor: start;">
                                                <tspan x="9" dy="3">0.4</tspan>
                                            </text>
                                        </g>
                                        <g class="tick" transform="translate(0,130)" style="opacity: 1;">
                                            <line x2="6" y2="0"></line>
                                            <text x="9" y="0" style="text-anchor: start;">
                                        ...
                                        <g class="tick" transform="translate(0,79)" style="opacity: 1;">
                                            <line x2="6" y2="0"></line>
                                            <text x="9" y="0" style="text-anchor: start;">
                                        ...
                                        <path class="domain" d="M6,1H0V259H6"></path>
                                    </g>
                                </g>
                                <g transform="translate(0.5,283.5)" style="visibility: hidden;">
                                    <g clip-path="url(file:///Users/giangvu/Documents/FinalProject/Templates/AdminTemplate/package/src/html/index.html#c3-1587526713352-clip-subchart)"
                                       class="c3-chart">
                                    ...
                                    <g clip-path="url(file:///Users/giangvu/Documents/FinalProject/Templates/AdminTemplate/package/src/html/index.html#c3-1587526713352-clip)"
                                       ...
                                       style="pointer-events: all; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                                        <rect class="background" x="0" width="374.984375"
                                ...
                                <g transform="translate(0,263)">
                                    <g class="c3-legend-item c3-legend-item-Direct-Sales"
                                       style="visibility: hidden; cursor: pointer;">
                                        <text x="14" y="9" style="pointer-events: none;">Direct Sales</text>
                                        ...
                                        <line class="c3-legend-item-tile" x1="-2" y1="4" x2="8" y2="4" stroke-width="10"
                                              style="stroke: rgb(237, 242, 246); pointer-events: none;"></line>
                                    </g>
                                    <g class="c3-legend-item c3-legend-item-Referral-Sales"
                                       style="visibility: hidden; cursor: pointer;">
                                        <text x="14" y="9" style="pointer-events: none;">Referral Sales</text>
                                        <rect class="c3-legend-item-event" x="0" y="-5" width="0" height="0"
                                              style="fill-opacity: 0;"></rect>
                                        <line class="c3-legend-item-tile" x1="-2" y1="4" x2="8" y2="4" stroke-width="10"
                                              style="stroke: rgb(95, 118, 232); pointer-events: none;"></line>
                                    </g>
                                    <g class="c3-legend-item c3-legend-item-Afilliate-Sales"
                                       style="visibility: hidden; cursor: pointer;">
                                        <text x="14" y="9" style="pointer-events: none;">Afilliate Sales</text>
                                        <rect class="c3-legend-item-event" x="0" y="-5" width="0" height="0"
                                              style="fill-opacity: 0;"></rect>
                                        <line class="c3-legend-item-tile" x1="-2" y1="4" x2="8" y2="4" stroke-width="10"
                                              style="stroke: rgb(255, 79, 112); pointer-events: none;"></line>
                                    </g>
                                    <g class="c3-legend-item c3-legend-item-Indirect-Sales"
                                       style="visibility: hidden; cursor: pointer;">
                                        <text x="14" y="9" style="pointer-events: none;">Indirect Sales</text>
                                        <rect class="c3-legend-item-event" x="0" y="-5" width="0" height="0"
                                              style="fill-opacity: 0;"></rect>
                                        <line class="c3-legend-item-tile" x1="-2" y1="4" x2="8" y2="4" stroke-width="10"
                                              style="stroke: rgb(1, 202, 241); pointer-events: none;"></line>
                                    </g>
                                </g>
                                <text class="c3-title" x="111.625" y="0"></text>
                            </svg>
                    ...
                    <div class="card-body">
                        ...
                        <div class="net-income mt-4 position-relative" style="height:294px;">
                            ...
                            <svg xmlns:ct="http://gionkunz.github.com/chartist-js/ct" width="100%" height="100%"
                                ...
                                <g class="ct-grids">
                                    <line y1="259" y2="259" x1="40" x2="174.984375" class="ct-grid ct-vertical"></line>
                                    <line y1="228.5" y2="228.5" x1="40" x2="174.984375"
                                          class="ct-grid ct-vertical"></line>
                                    <line y1="198" y2="198" x1="40" x2="174.984375" class="ct-grid ct-vertical"></line>
                                    <line y1="167.5" y2="167.5" x1="40" x2="174.984375"
                                          class="ct-grid ct-vertical"></line>
                                    <line y1="137" y2="137" x1="40" x2="174.984375" class="ct-grid ct-vertical"></line>
                                    <line y1="106.5" y2="106.5" x1="40" x2="174.984375"
                                          class="ct-grid ct-vertical"></line>
                                    <line y1="76" y2="76" x1="40" x2="174.984375" class="ct-grid ct-vertical"></line>
                                    <line y1="45.5" y2="45.5" x1="40" x2="174.984375"
                                          class="ct-grid ct-vertical"></line>
                                    <line y1="15" y2="15" x1="40" x2="174.984375" class="ct-grid ct-vertical"></line>
                                </g>
                                <g>
                                    <g class="ct-series ct-series-a">
                                        <line x1="51.248697916666664" x2="51.248697916666664" y1="259" y2="137"
                                              class="ct-bar" ct:value="5"></line>
                                        <line x1="73.74609375" x2="73.74609375" y1="259" y2="161.4" class="ct-bar"
                                              ct:value="4"></line>
                                        <line x1="96.24348958333333" x2="96.24348958333333" y1="259" y2="185.8"
                                              class="ct-bar" ct:value="3"></line>
                                        <line x1="118.74088541666667" x2="118.74088541666667" y1="259"
                                              y2="88.19999999999999" class="ct-bar" ct:value="7"></line>
                                        <line x1="141.23828124999997" x2="141.23828124999997" y1="259" y2="137"
                                              class="ct-bar" ct:value="5"></line>
                                        <line x1="163.73567708333331" x2="163.73567708333331" y1="259" y2="15"
                                              class="ct-bar" ct:value="10"></line>
                                    </g>
                                </g>
                                <g class="ct-labels">
                                    <foreignObject style="overflow: visible;" x="40" y="264" width="22.497395833333332"
                                                   height="20"><span class="ct-label ct-horizontal ct-end"
                                                                     xmlns="http://www.w3.org/2000/xmlns/"
                                                                     style="width: 22px; height: 20px;">Jan</span>
                                    </foreignObject>
                                    <foreignObject style="overflow: visible;" x="62.49739583333333" y="264"
                                                   width="22.497395833333332" height="20"><span
                                            class="ct-label ct-horizontal ct-end" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="width: 22px; height: 20px;">Feb</span></foreignObject>
                                    <foreignObject style="overflow: visible;" x="84.99479166666666" y="264"
                                                   width="22.497395833333336" height="20"><span
                                            class="ct-label ct-horizontal ct-end" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="width: 22px; height: 20px;">Mar</span></foreignObject>
                                    <foreignObject style="overflow: visible;" x="107.4921875" y="264"
                                                   width="22.49739583333333" height="20"><span
                                            class="ct-label ct-horizontal ct-end" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="width: 22px; height: 20px;">Apr</span></foreignObject>
                                    <foreignObject style="overflow: visible;" x="129.98958333333331" y="264"
                                                   width="22.49739583333333" height="20"><span
                                            class="ct-label ct-horizontal ct-end" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="width: 22px; height: 20px;">May</span></foreignObject>
                                    <foreignObject style="overflow: visible;" x="152.48697916666666" y="264" width="30"
                                                   height="20"><span class="ct-label ct-horizontal ct-end"
                                                                     xmlns="http://www.w3.org/2000/xmlns/"
                                                                     style="width: 30px; height: 20px;">Jun</span>
                                    </foreignObject>
                                    <foreignObject style="overflow: visible;" y="228.5" x="0" height="30.5"
                                                   width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="height: 31px; width: 30px;">0</span></foreignObject>
                                    <foreignObject style="overflow: visible;" y="198" x="0" height="30.5"
                                                   width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="height: 31px; width: 30px;">1.25</span></foreignObject>
                                    <foreignObject style="overflow: visible;" y="167.5" x="0" height="30.5"
                                                   width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="height: 31px; width: 30px;">2.5</span></foreignObject>
                                    <foreignObject style="overflow: visible;" y="137" x="0" height="30.5"
                                                   width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="height: 31px; width: 30px;">3.75</span></foreignObject>
                                    <foreignObject style="overflow: visible;" y="106.5" x="0" height="30.5"
                                                   width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="height: 31px; width: 30px;">5</span></foreignObject>
                                    <foreignObject style="overflow: visible;" y="76" x="0" height="30.5"
                                                   width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="height: 31px; width: 30px;">6.25</span></foreignObject>
                                    <foreignObject style="overflow: visible;" y="45.5" x="0" height="30.5"
                                                   width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="height: 31px; width: 30px;">7.5</span></foreignObject>
                                    <foreignObject style="overflow: visible;" y="15" x="0" height="30.5"
                                                   width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                                            style="height: 31px; width: 30px;">8.75</span></foreignObject>
                                    <foreignObject style="overflow: visible;" y="-15" x="0" height="30" width="30"><span
                                            class="ct-label ct-vertical ct-start" xmlns="http://www.w3.org/2000/xmlns/"
                        ...
                        <div class="" style="height:180px">
                            <div id="visitbylocate" style="height:100%">
                                <div class="jvectormap-container" style="background-color: transparent;">
                                    <svg width="189.984" height="180">
                                        <defs></defs>
                                        <g transform="scale(0.21109333333333336) translate(0, 205.99853740206183)">
                                            <path
                                                ...
                                                data-code="BD" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                            ...
                                            <path
                                                ...
                                                data-code="BE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BF" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BG" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="BO" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="JP" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M495.45,295.49l-1.08,-2.99l1.14,-0.11l0.64,-1.19l0.76,0.09l0.65,1.83l-2.1,2.36Z"
                                                data-code="BI" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="BW" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BS" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="RS" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LT" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path d="M436.08,149.45l-0.48,-0.07l0.3,-1.28l0.27,0.4l-0.09,0.96Z"
                                                  data-code="LU" fill="#d5dce5" fill-opacity="1"
                                                  stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                  fill-rule="evenodd"
                                            ...
                                            <path
                                                ...
                                                data-code="LR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="RO" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GW" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GT" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path d="M448.79,279.62l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z"
                                                  data-code="GQ" fill="#d5dce5" fill-opacity="1"
                                                  stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                  fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GY" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GB" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="GM" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="GH" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="JO" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HT" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HU" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="PT" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PY" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PA" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PG" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PK" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PH" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PL" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path d="M504.91,192.87l0.34,0.01l0.27,-0.07l-0.29,0.26l-0.31,-0.2Z"
                                                  data-code="-99" fill="#d5dce5" fill-opacity="1"
                                                  stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                  fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ZM" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EH" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EG" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ZA" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EC" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AL" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AO" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="KZ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="ES" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="MD" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MG" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MA" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UZ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MM" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ML" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MN" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MK" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MW" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UG" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MY" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MX" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path d="M839.04,322.8l0.22,1.14l-0.44,0.03l-0.2,-1.45l0.42,0.27Z"
                                                  data-code="VU" fill="#d5dce5" fill-opacity="1"
                                                  stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                  fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="FJ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="FK" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NI" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NL" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NO" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NA" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M838.78,341.24l-0.33,0.22l-2.9,-1.75l-3.26,-3.37l1.65,0.83l4.85,4.07Z"
                                                data-code="NC" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NG" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NZ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NP" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CI" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CH" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CO" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CN" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CM" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CL" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CA" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CG" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CF" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CD" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CZ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M504.36,193.47l0.43,0.28l-1.28,0.57l-0.92,-0.28l-0.24,-0.46l2.01,-0.13Z"
                                                data-code="CY" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="SY" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="SS" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="SK" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="KR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="SO" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SN" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SL" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SB" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SA" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SD" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DO" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DJ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DK" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="YE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AT" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DZ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="US" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LV" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="TM" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="TH" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M596.68,420.38l-3.2,0.18l-0.05,-1.26l0.39,-1.41l1.3,0.78l2.08,0.35l-0.52,1.36Z"
                                                data-code="TF" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TG" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TD" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LY" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="VE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AF" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IQ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IS" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AM" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IT" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="VN" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AR" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AU" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IL" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IN" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TZ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AZ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IE" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ID" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="MZ" fill="#d5dce5" fill-opacity="1"
                                                stroke="rgba(255, 255, 255, 0.5)" stroke-width="1" stroke-opacity="1"
                                                fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                                        </g>
                                        <g></g>
                        ...
                        <div class="pl-4 mb-5">
                            <div class="stats ct-charts position-relative" style="height: 315px;">
                                ...
                                <svg xmlns:ct="http://gionkunz.github.com/chartist-js/ct" width="100%" height="100%"
                                    ...
                                    <g class="ct-grids">
                                        <line x1="30" x2="30" y1="15" y2="280" class="ct-grid ct-horizontal"></line>
                                        <line x1="95.16666666666667" x2="95.16666666666667" y1="15" y2="280"
                                              class="ct-grid ct-horizontal"></line>
                                        <line x1="160.33333333333334" x2="160.33333333333334" y1="15" y2="280"
                                              class="ct-grid ct-horizontal"></line>
                                        <line x1="225.5" x2="225.5" y1="15" y2="280"
                                              class="ct-grid ct-horizontal"></line>
                                        <line x1="290.6666666666667" x2="290.6666666666667" y1="15" y2="280"
                                              class="ct-grid ct-horizontal"></line>
                                        <line x1="355.83333333333337" x2="355.83333333333337" y1="15" y2="280"
                                              class="ct-grid ct-horizontal"></line>
                                        <line x1="421" x2="421" y1="15" y2="280" class="ct-grid ct-horizontal"></line>
                                        <line y1="280" y2="280" x1="30" x2="421" class="ct-grid ct-vertical"></line>
                                        <line y1="235.83333333333334" y2="235.83333333333334" x1="30" x2="421"
                                              class="ct-grid ct-vertical"></line>
                                        <line y1="191.66666666666669" y2="191.66666666666669" x1="30" x2="421"
                                              class="ct-grid ct-vertical"></line>
                                        <line y1="147.5" y2="147.5" x1="30" x2="421" class="ct-grid ct-vertical"></line>
                                        <line y1="103.33333333333334" y2="103.33333333333334" x1="30" x2="421"
                                              class="ct-grid ct-vertical"></line>
                                        <line y1="59.16666666666666" y2="59.16666666666666" x1="30" x2="421"
                                              class="ct-grid ct-vertical"></line>
                                        <line y1="15" y2="15" x1="30" x2="421" class="ct-grid ct-vertical"></line>
                                    </g>
                                    <g>
                                        <g class="ct-series ct-series-a">
                                            <path
                                                d="M30,280L30,182.833C51.722,185.778,73.444,191.667,95.167,191.667C116.889,191.667,138.611,163.561,160.333,147.5C182.056,131.439,203.778,94.5,225.5,94.5C247.222,94.5,268.944,156.333,290.667,156.333C312.389,156.333,334.111,76.833,355.833,76.833C377.556,76.833,399.278,141.611,421,174L421,280Z"
                                                class="ct-area" x1="NaN"></path>
                                            <path
                                                d="M30,182.833C51.722,185.778,73.444,191.667,95.167,191.667C116.889,191.667,138.611,163.561,160.333,147.5C182.056,131.439,203.778,94.5,225.5,94.5C247.222,94.5,268.944,156.333,290.667,156.333C312.389,156.333,334.111,76.833,355.833,76.833C377.556,76.833,399.278,141.611,421,174"
                                                class="ct-line"></path>
                                            <line x1="30" y1="182.83333333333331" x2="30.01" y2="182.83333333333331"
                                                  class="ct-point" ct:value="11"></line>
                                            <line x1="95.16666666666667" y1="191.66666666666669" x2="95.17666666666668"
                                                  y2="191.66666666666669" class="ct-point" ct:value="10"></line>
                                            <line x1="160.33333333333334" y1="147.5" x2="160.34333333333333" y2="147.5"
                                                  class="ct-point" ct:value="15"></line>
                                            <line x1="225.5" y1="94.5" x2="225.51" y2="94.5" class="ct-point"
                                                  ct:value="21"></line>
                                            <line x1="290.6666666666667" y1="156.33333333333331" x2="290.6766666666667"
                                                  y2="156.33333333333331" class="ct-point" ct:value="14"></line>
                                            <line x1="355.83333333333337" y1="76.83333333333334" x2="355.84333333333336"
                                                  y2="76.83333333333334" class="ct-point" ct:value="23"></line>
                                            <line x1="421" y1="174" x2="421.01" y2="174" class="ct-point"
                                                  ct:value="12"></line>
                                        </g>
                                    </g>
                                    <g class="ct-labels">
                                        <foreignObject style="overflow: visible;" x="30" y="285"
                                                       width="65.16666666666667"
                                                       height="20"><span class="ct-label ct-horizontal ct-end"
                                                                         xmlns="http://www.w3.org/2000/xmlns/"
                                                                         style="width: 65px; height: 20px;">Mon</span>
                                        </foreignObject>
                                        <foreignObject style="overflow: visible;" x="95.16666666666667" y="285"
                                                       width="65.16666666666667" height="20"><span
                                                class="ct-label ct-horizontal ct-end"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="width: 65px; height: 20px;">Tue</span></foreignObject>
                                        <foreignObject style="overflow: visible;" x="160.33333333333334" y="285"
                                                       width="65.16666666666666" height="20"><span
                                                class="ct-label ct-horizontal ct-end"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="width: 65px; height: 20px;">Wed</span></foreignObject>
                                        <foreignObject style="overflow: visible;" x="225.5" y="285"
                                                       width="65.16666666666669" height="20"><span
                                                class="ct-label ct-horizontal ct-end"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="width: 65px; height: 20px;">Thu</span></foreignObject>
                                        <foreignObject style="overflow: visible;" x="290.6666666666667" y="285"
                                                       width="65.16666666666669" height="20"><span
                                                class="ct-label ct-horizontal ct-end"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="width: 65px; height: 20px;">Fri</span></foreignObject>
                                        <foreignObject style="overflow: visible;" x="355.83333333333337" y="285"
                                                       width="65.16666666666663" height="20"><span
                                                class="ct-label ct-horizontal ct-end"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="width: 65px; height: 20px;">Sat</span></foreignObject>
                                        <foreignObject style="overflow: visible;" x="421" y="285" width="30"
                                                       height="20">
                                        <span class="ct-label ct-horizontal ct-end"
                                              xmlns="http://www.w3.org/2000/xmlns/" style="width: 30px; height: 20px;">Sun</span>
                                        </foreignObject>
                                        <foreignObject style="overflow: visible;" y="235.83333333333334" x="10"
                                                       height="44.166666666666664" width="10"><span
                                                class="ct-label ct-vertical ct-start"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="height: 44px; width: 10px;">0k</span></foreignObject>
                                        <foreignObject style="overflow: visible;" y="191.66666666666669" x="10"
                                                       height="44.166666666666664" width="10"><span
                                                class="ct-label ct-vertical ct-start"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="height: 44px; width: 10px;">5k</span></foreignObject>
                                        <foreignObject style="overflow: visible;" y="147.5" x="10"
                                                       height="44.16666666666667" width="10"><span
                                                class="ct-label ct-vertical ct-start"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="height: 44px; width: 10px;">10k</span></foreignObject>
                                        <foreignObject style="overflow: visible;" y="103.33333333333334" x="10"
                                                       height="44.16666666666666" width="10"><span
                                                class="ct-label ct-vertical ct-start"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="height: 44px; width: 10px;">15k</span></foreignObject>
                                        <foreignObject style="overflow: visible;" y="59.16666666666666" x="10"
                                                       height="44.166666666666686" width="10"><span
                                                class="ct-label ct-vertical ct-start"
                                                xmlns="http://www.w3.org/2000/xmlns/"
                                                style="height: 44px; width: 10px;">20k</span></foreignObject>
                                        <foreignObject style="overflow: visible;" y="15" x="10"
                                                       height="44.16666666666666"
                                                       width="10"><span class="ct-label ct-vertical ct-start"
                                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                                        style="height: 44px; width: 10px;">25k</span>
                                        </foreignObject>
                                        <foreignObject style="overflow: visible;" y="-15" x="10" height="30" width="10">
                                        <span class="ct-label ct-vertical ct-start"
                                              xmlns="http://www.w3.org/2000/xmlns/" style="height: 30px; width: 10px;">30k</span>
                                        </foreignObject>
                                    </g>
                                    <defs>
                                        <linearGradient id="gradient" x1="0" y1="1" x2="0" y2="0">
                                            <stop offset="0" stop-color="rgba(255, 255, 255, 1)"></stop>
                                            <stop offset="1" stop-color="rgba(80, 153, 255, 1)"></stop>
                                        </linearGradient>
                                    </defs>
                                </svg>
                            </div>
                            ...
                            <table class="table no-wrap v-middle mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="border-top-0 text-center px-2 py-4"><i
                                            ...
                                            data-placement="top" title="" data-original-title="In Testing"></i></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center px-2 py-4"><i class="fa fa-circle text-danger font-12"
                                                                         data-toggle="tooltip" data-placement="top"
                                                                         title=""
                                                                         data-original-title="In Progress"></i></td>
...
@section('script')
    ...
    <script src="admin_assets/assets/extra-libs/c3/d3.min.js"></script>
    <script src="admin_assets/assets/extra-libs/c3/c3.min.js"></script>
    <script src="admin_assets/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="admin_assets/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <script src="admin_assets/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="admin_assets/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"></script>
    <script src="admin_assets/dist/js/pages/dashboards/dashboard1.min.js"></script>
@endsection
