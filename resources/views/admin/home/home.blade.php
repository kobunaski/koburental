        ...
        <div class="card-group">
                    ...
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <div class="d-inline-flex align-items-center">
                                <h2 class="text-dark mb-1 font-weight-medium">{{count($User)}}</h2>
                                <span
                    ...
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup
                                    class="set-doller">$</sup>{{$PaymentMonthly}}</h2>
            ...
            <div class="card border-right">
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <div class="d-inline-flex align-items-center">
                                <h2 class="text-dark mb-1 font-weight-medium">{{count($Vehicle)}}</h2>
                            </div>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Vehicles</h6>
                        </div>
                        <div class="ml-auto mt-md-3 mt-lg-0">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <h2 class="text-dark mb-1 font-weight-medium">{{count($Booking)}}</h2>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Bookings</h6>
                        </div>
                        <div class="ml-auto mt-md-3 mt-lg-0">
                                    ...
                                    <div class="ml-3 mt-2">
                                        @foreach($User as $item2)
                                            @if($item2 -> id == $item -> id_user)
                                                <h5 class="text-dark font-weight-medium mb-2">{{$item2 -> name}}</h5>
                                            @endif
                                        @endforeach
                                        @foreach($Vehicle as $item2)
                                            @if($item2 -> id == $item -> id_vehicle)
                                                    <p class="font-14 mb-2 text-muted">{{$item -> content}} <br>
                                                        {{$item2 -> name}}</p>
                                            @endif
                                        @endforeach
                                        <span
                                            class="font-weight-light font-14 text-muted">{{$item -> created_at}}</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
