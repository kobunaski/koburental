                    ...
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;">
                        ...
                        <div class="column" style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                            ...
                            <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                <img style="border: 0;display: block;height: auto;width: 100%;max-width: 600px;" alt="" width="600" src="images/property_item_cars_09-9900000000079e3c-c1b8db085100ae09.jpg" />
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #43464a;font-size: 17px;line-height: 26px;">Hi there,</h2><p style="Margin-top: 16px;Margin-bottom: 0;">Thank you for your reservation at our website. Our mission has always been to deliver the best experience to the customers who used our service.&nbsp;</p><p style="Margin-top: 20px;Margin-bottom: 20px;">Your payment went through successfully on 4.&nbsp;Please come to your pickup place at 9AM in order to receive the vehicle. Here are the details of the order.</p>
                                </div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 0;">Customer name: {{$User -> name}}&nbsp;</p><p style="Margin-top: 20px;Margin-bottom: 0;">Order id: {{$Booking -> id}}</p><p style="Margin-top: 20px;Margin-bottom: 0;">Vehicle name {{$Vehicle -> name}}</p><p style="Margin-top: 20px;Margin-bottom: 0;">Deposit:</p><p style="Margin-top: 20px;Margin-bottom: 0;">Pickup day: {{$Booking -> pickup_date}}-&gt; Return day:{{$Booking -> return_date}}</p><p style="Margin-top: 20px;Margin-bottom: 20px;">Pickup location: {{$PickupLocation -> name}}&nbsp;</p>
                                </div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 0;">Thanks for your trust in us,<br />
                ...
                <div role="contentinfo">
                    ...
                    <div class="layout one-col email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                            ...
                            <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #b8b8b8;font-family: Ubuntu,sans-serif;">
                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
