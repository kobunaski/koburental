<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--[if IE]><html xmlns="http://www.w3.org/1999/xhtml" class="ie"><![endif]--><!--[if !IE]><!--><html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]--><head>
    ...
    <!--[if !mso]><!--><style type="text/css">
        ...
        body{background-color:#f2f2f2}.logo a:hover,.logo a:focus{color:#859bb1 !important}.mso .layout-has-border{border-top:1px solid #bfbfbf;border-bottom:1px solid #bfbfbf}.mso .layout-has-bottom-border{border-bottom:1px solid #bfbfbf}.mso .border,.ie .border{background-color:#bfbfbf}.mso h1,.ie h1{}.mso h1,.ie h1{font-size:26px !important;line-height:34px !important}.mso h2,.ie h2{}.mso h2,.ie h2{font-size:20px !important;line-height:28px !important}.mso h3,.ie h3{}.mso .layout__inner,.ie .layout__inner{}.mso .footer__share-button p{}.mso .footer__share-button p{font-family:Ubuntu,sans-serif}
                        ...
                        <div class="column" style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #43464a;font-size: 17px;line-height: 26px;">Hi there,</h2><p style="Margin-top: 16px;Margin-bottom: 20px;">Please verify the email by clicking on the link below</p>
                                </div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                                    ...
                                    <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://localhost/finalproject2/public/email/verify/{{$id}}" style="width:236px" arcsize="9%" fillcolor="#00AFD1" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FF5C5C;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Verify your email</center></v:textbox></v:roundrect><![endif]--></div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 0;">Thanks for signing up,<br />
                                        <strong>KoBu Car Rental</strong></p>
                                </div>
                            </div>
...
{{--<!--<![endif]-->--}}
{{--<table class="wrapper"--}}
       {{--style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f2f2f2;"--}}
            ...
            {{--<div>--}}
                {{--<div class="layout one-col fixed-width stack"--}}
                    ...
                    {{--<div class="layout__inner"--}}
                        ...
                        {{--<div class="column"--}}
                             {{--style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: sans-serif;">--}}

                            {{--<div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;"--}}
                                 {{--align="center">--}}
                                {{--<img style="border: 0;display: block;height: auto;width: 100%;max-width: 600px;" alt=""--}}
                                     {{--width="600" src="images/17-feedback-9900000000079e3c.jpg"/>--}}
                            {{--</div>--}}
                            ...
                            {{--<div style="Margin-left: 20px;Margin-right: 20px;">--}}
                                {{--<div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">--}}
                                    {{--<h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #43464a;font-size: 17px;line-height: 26px;">--}}
                                        {{--Hi there,</h2>--}}
                                    {{--<p style="Margin-top: 16px;Margin-bottom: 20px;">Please verify the email by clicking on the link below</p>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            ...
                            {{--<div style="Margin-left: 20px;Margin-right: 20px;">--}}
                                {{--<div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">--}}
                                    {{--<![if !mso]><a--}}
                                        {{--style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #FF5C5C;font-family: sans-serif;"--}}
                                        {{--href="http://localhost/finalproject2/public/email/verify/{{$id}}">Please verify the email</a><![endif]>--}}
                                    {{--<!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p>--}}
                                    {{--<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://localhost/finalproject2/public/email/verify/{{$id}}"--}}
                                                 {{--style="width:236px" arcsize="9%" fillcolor="#00AFD1" stroke="f">--}}
                                        {{--<v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px">--}}
                                            {{--<center--}}
                                                {{--style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">--}}
                                                {{--Verify Email--}}
                                            {{--</center>--}}
                                        {{--</v:textbox>--}}
                            ...
                            {{--<div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">--}}
                                {{--<div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">--}}
                                    {{--<p style="Margin-top: 0;Margin-bottom: 0;">If you are not registering account on our website, please ignore this email<br/>--}}
                                        {{--<strong>KoBu Car Rental</strong></p>--}}
                                {{--</div>--}}
                            {{--</div>--}}
